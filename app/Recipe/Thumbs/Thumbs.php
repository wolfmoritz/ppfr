...
$app->get("/{$config['file.thumb.uri']}:recipeId/:dims/:imageName", function ($recipeId, $dims, $imageName) use ($app, $config) {
  ...
  $thumbSizeDirectory = $config['file.thumb.path'] . $recipeId . '/' . $width . 'x' . $height;
